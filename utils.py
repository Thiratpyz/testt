...
if correct is None:
    raise FileNotFoundError("The image file 'right.png' was not found or could not be read.")
if incorrect is None:
    raise FileNotFoundError("The image file 'wrong.png' was not found or could not be read.")
